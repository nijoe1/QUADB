...
abstract contract MACIQVBase is BaseStrategy, Multicall {
    /// ================================
    /// ========== Structs =============
    /// ================================
    ...
    /// @notice Initializes the MACIQVBase contract
    ...
    function _MACIQVBaseStrategy_init(uint256 _poolId, InitializeParams memory _params) internal {
    ...
    function _getAllocatedAmount(uint256 _tallyResult) internal view returns (uint256) {
        return (_tallyResult * _tallyResult * poolAmount  / totalVotesSquares) ;
    }
}
