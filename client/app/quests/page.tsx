...
import { Shield, Database, CoinsIcon, Scale, AlertTriangle, CheckCircle2 } from "lucide-react";
        ...
        <div className="mx-auto max-w-6xl p-10">
          ...
          >
            <motion.div variants={itemVariants} className="mb-16 text-center">
              <h1 className="mb-6 text-4xl font-bold text-white">Data Quests</h1>
            ...
            <div className="grid gap-12 md:grid-cols-2">
              <motion.div variants={itemVariants} className="rounded-xl bg-white p-8 shadow-lg">
                ...
                <p className="text-grey-600">
                  Curators stake tokens on their datasets, demonstrating confidence in data quality
              ...
              <motion.div variants={itemVariants} className="rounded-xl bg-white p-8 shadow-lg">
                ...
                <p className="text-grey-600">
                  Data consumers verify dataset validity through a deterministic and user-friendly
                  verification system.
                </p>
              </motion.div>
            </div>

            <motion.div variants={itemVariants} className="mt-12 rounded-xl bg-white p-8 shadow-lg">
              <h2 className="mb-6 text-2xl font-bold text-grey-800">Dispute Resolution Flow</h2>
            ...
            >
              <h2 className="mb-6 text-2xl font-bold text-grey-800">Tokenomics Highlights</h2>
              <div className="grid gap-8 md:grid-cols-2">
                <div>
                  <h3 className="mb-2 font-semibold text-grey-700">Curator Incentives</h3>
                ...
                <div>
                  <h3 className="mb-2 font-semibold text-grey-700">Verification Rewards</h3>
                  <ul className="list-inside list-disc space-y-2 text-grey-600">
