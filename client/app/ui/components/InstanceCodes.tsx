...
import { getFileMetadata, getIpfsGatewayUri, resolveIPNS } from "@/lib/ipfs";
...
const InstanceCodes = ({ hasAccess, InstanceID }: { hasAccess: boolean; InstanceID: string }) => {
  ...
  async function fetchInstanceCodes() {
    ...
    for (const key in data) {
      ...
      data[key].codeCID = getIpfsGatewayUri((await getFileMetadata(ipnsValue)).dataCID);
